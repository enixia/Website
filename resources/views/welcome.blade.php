...
@section('content')
                            ...
                            <div class="col-md-12">
                                <div class="swiper-container">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide" style="background-image:url({{asset('storage/app/images/template/drag1.png') }})"></div>
                                        <div class="swiper-slide" style="background-image:url({{asset('storage/app/images/template/drag2.png') }})"></div>
                                        <div class="swiper-slide" style="background-image:url({{asset('storage/app/images/template/drag3.png') }})"></div>
                                    </div>
                            ...
                            <div class="screen01 roomy-50">
                                <div class="col-md-6">
                                    <div class="screen01_img text-center">
                                        ...
                                        <img src="{{asset('storage/app/images/template/screen01.png') }}" alt="" />
                                ...
                                <div class="col-md-6">
                                    <div class="screen01_content m-top-100">
                                        <div class="screen01_content_img ">
                                            <img src="{{asset('storage/app/images/template/cloud1.png') }}" alt="" />
                                        </div>
                            ...
                            <div class="screen02 roomy-50 m-top-100">
                                <div class="col-md-6 col-md-push-6">
                                    <div class="screen02_img text-center">
                                        ...
                                        <img src="{{asset('storage/app/images/template/screen02.png') }}" alt="" />
                                ...
                                <div class="col-md-6 col-md-pull-6">
                                    <div class="screen02_content m-top-100">
                                        <div class="screen02_content_img ">
                                            <img src="{{asset('storage/app/images/template/sun1.png') }}" alt="" />
                                        </div>
                                        <h2 class="m-top-40">When the clouds</h2>
                            ...
                            <div class="screen03 roomy-50 m-top-100">
                                <div class="col-md-6">
                                    <div class="screen03_img text-center">
                                        ...
                                        <img src="{{asset('storage/app/images/template/screen03.png') }}" alt="" />
                                ...
                                <div class="col-md-6">
                                    <div class="screen03_content m-top-100">
                                        <div class="screen03_content_img ">
                                            <img src="{{asset('storage/app/images/template/rainy1.png') }}" alt="" />
                                        </div>
            ...
            <section id="download" class="download m-top-100">
                <div class="download_overlay" style="background: url({{asset('storage/app/images/template/bodybg.png')}}) repeat-y;"></div>
                <div class="container">
                    <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="download_item roomy-100">
                                    ...
                                    <div class="download_app m-top-30">
                                        <a href=""><img src="{{asset('storage/app/images/template/appstor.png') }}" alt="" /></a>
                                        <a href=""><img src="{{asset('storage/app/images/template/googleplay.png') }}" alt="" /></a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="download_item m-top-70">
                                    <img class="app_right" src="{{asset('storage/app/images/template/appdownload1.png') }}" alt="" />
                                </div>
                            </div>
                        </div>
                    </div>
